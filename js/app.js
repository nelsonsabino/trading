// app.js - VERSÃO REPARADA E COMPLETA
// Contém toda a funcionalidade original mais a correção para o lightbox de imagens.
...
function runApp() {
    ...
    function createTradeCard(trade) {
        ...
        if (imageUrlToShow) {
            ...
            // Esta linha estava em falta ou não funcionava na sua versão original.
        ...
        // Lógica dos botões de ação (original do seu app.js)
        let actionButton;
