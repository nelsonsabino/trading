    ...
    try {
        ...
        for (const alarm of data) {
            ...
            if (alarm.alarm_type === 'stochastic') {
                ...
                alarmDescription = `Preço testa a EMA(${alarm.ema_period}) como ${alarm.condition === 'test_support' ? 'SUPORTE' : 'RESISTÊNCIA'} no ${alarm.indicator_timeframe}`;
...
async function deleteAlarm(alarmId) {
    ...
    } catch (error) { console.error("Erro ao apagar alarme:", error); }
}
